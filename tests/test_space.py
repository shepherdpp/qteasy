...
class TestSpace(unittest.TestCase):
    ...
    def test_axis_extract(self):
        ...
        self.assertTrue(np.allclose(axis.gen_value(1, 'int'), [0., 1., 2., 3., 4.]))
        self.assertTrue(np.allclose(axis.gen_value(0.5, 'int'), [0., 0.5, 1., 1.5, 2., 2.5, 3., 3.5, 4., 4.5]))
        extracted = axis.gen_value(8, 'rand')
        ...
        self.assertTrue(np.allclose(axis.gen_value(1, 'int'), [1, 2, 3, 4, 5]))
        self.assertRaises(ValueError, axis.gen_value, 0.5, 'int')
        extracted = axis.gen_value(8, 'rand')
        self.assertEqual(len(extracted), 8)
        ...
        self.assertEqual(axis.gen_value(1, 'int'), [1, 5, 7, 10, 'A', 'F'])
        self.assertRaises(ValueError, axis.gen_value, 0.5, 'int')
        extracted = axis.gen_value(8, 'rand')
        self.assertEqual(len(extracted), 8)
