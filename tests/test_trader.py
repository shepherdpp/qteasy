...
class TestTrader(unittest.TestCase):
    ...
    def test_trader(self):
        ...
        target_agenda = [
            ...
            ('09:45:00', 'acquire_live_price'),
            ('10:00:00', 'acquire_live_price'),
            ('10:00:00', 'run_strategy', ['macd', 'dma']),
            ('10:15:00', 'acquire_live_price'),
            ('10:30:00', 'acquire_live_price'),
            ('10:30:00', 'run_strategy', ['macd']),
            ('10:45:00', 'acquire_live_price'),
            ('11:00:00', 'acquire_live_price'),
