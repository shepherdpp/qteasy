...
DATA_TABLE_MAPPING = {
    ...
    ('name', 'd', 'E'):           ['stk_rewards', 'name', '管理层薪酬 - 姓名'],
    ('title', 'd', 'E'):          ['stk_rewards', 'title', '管理层薪酬 - 职务'],
    ...
    ('amount', 'd', 'E'):         ['new_share', 'amount', '新股上市信息 - 发行总量（万股）'],
