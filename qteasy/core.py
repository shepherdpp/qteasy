...
def run_backtest_mode(op, config):
...
def run_optimize_mode(op, config):
...
def run_trace_mode(op, config):
    """ run qteasy in mode 3: tracing mode"""
    raise NotImplementedError


def run_predict_mode(op, config):
    """ run qteasy in mode 4: predict mode"""
    raise NotImplementedError
