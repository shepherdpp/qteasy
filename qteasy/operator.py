...
class Operator:
    ...
    def __init__(self, selecting_types=None,
        ...
        目前在Operator对象中可以支持的策略有三种类型，而每种类型的策略都有不同的种类，三种类型的策略分别如下：
            ...
            3,  单品种信号生成策略，目前称为风控策略
                ...
                同理，择时或选股同样也是策略的目标，单纯的择时或选股都可以通过第一类或第二类策略来实现。
        ...
        以上三类策略通过不同的方式混合后，可以组成任意一种复杂的策略，因此，在qteasy系统中，复杂的策略是可以由很多个简单的策略组合而来
        的。
