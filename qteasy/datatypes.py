...
def _parse_user_defined_freqs_and_asset_types(name: str) -> tuple[list[str], list[str]]:
    ...
    -------
    tuple
        user_defined_freqs: list of str
            数据的频率
...
class DataType:
    ...
    acquisition_types = [
        ...
        'category',
        # 成分分类数据，输出某个股票属于哪一个成分，该成分是静态的与时间无关，如行业分类、地域分类等
        # 以下为一些特殊类型，由特殊的过程实现
        'complex',
...
DATA_TYPE_MAP = {
    ...
    ('total_share', 'd', 'IDX'):                      ['指数技术指标 - 当日总股本（股）', 'direct',
    ...
    ('float_mv_2', 'd', 'E'):                         ['股票技术指标 - 流通市值(亿元)', 'direct',
                                                       {'table_name': 'stock_indicator2', 'column': 'float_mv'}],
    ('total_mv_2', 'd', 'E'):                         ['股票技术指标 - 总市值(亿元)', 'direct',
