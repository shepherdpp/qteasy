...
# ('sw_level1','None','IDX'):	['申万行业分类筛选 - L1','selection',{'table_name': 'sw_industry_basic', 'column': 'level', 'keys': ['L1']}],
# ('sw_level2','None','IDX'):	['申万行业分类筛选 - L2','selection',{'table_name': 'sw_industry_basic', 'column': 'level', 'keys': ['L2']}],
...
('ci_change','d','IDX'):	['中信指数日K线 - 最低价','direct',{'table_name': 'ci_index_daily', 'column': 'change'}],
