...
('manager_title','d','E'):	['公司高管信息 - 岗位','direct',{'table_name': 'stk_managers', 'column': 'title'}],
('edu','d','E'):	['公司高管信息 - 学历','direct',{'table_name': 'stk_managers', 'column': 'edu'}],
('national','d','E'):	['公司高管信息 - 国籍','direct',{'table_name': 'stk_managers', 'column': 'national'}],
('birthday','d','E'):	['公司高管信息 - 出生年月','direct',{'table_name': 'stk_managers', 'column': 'birthday'}],
('begin_date','d','E'):	['公司高管信息 - 上任日期','direct',{'table_name': 'stk_managers', 'column': 'begin_date'}],
('end_date','d','E'):	['公司高管信息 - 离任日期','direct',{'table_name': 'stk_managers', 'column': 'end_date'}],
('resume','d','E'):	['公司高管信息 - 个人简历','direct',{'table_name': 'stk_managers', 'column': 'resume'}],
...
('ipo_date','d','E'):	['新股上市信息 - 上网发行日期','direct',{'table_name': 'new_share', 'column': 'ipo_date'}],
('issue_date','d','E'):	['新股上市信息 - 上市日期','direct',{'table_name': 'new_share', 'column': 'issue_date'}],
('IPO_amount','d','E'):	['新股上市信息 - 发行总量（万股）','direct',{'table_name': 'new_share', 'column': 'amount'}],
('market_amount','d','E'):	['新股上市信息 - 上网发行总量（万股）','direct',{'table_name': 'new_share', 'column': 'market_amount'}],
('initial_price','d','E'):	['新股上市信息 - 发行价格','direct',{'table_name': 'new_share', 'column': 'price'}],
('initial_pe','d','E'):	['新股上市信息 - 发行市盈率','direct',{'table_name': 'new_share', 'column': 'pe'}],
('limit_amount','d','E'):	['新股上市信息 - 个人申购上限（万股）','direct',{'table_name': 'new_share', 'column': 'limit_amount'}],
('funds','d','E'):	['新股上市信息 - 募集资金（亿元）','direct',{'table_name': 'new_share', 'column': 'funds'}],
('ballot','d','E'):	['新股上市信息 - 中签率','direct',{'table_name': 'new_share', 'column': 'ballot'}],
...
('express_total_hldr_eqy_exc_min_int','q','E'):	['上市公司业绩快报 - 股东权益合计(不含少数股东权益)(元)','direct',{'table_name': 'total_hldr_eqy_exc_min_int', 'column': ''}],
...
('close','d','Any'):	['融资融券交易明细 - 收盘价','direct',{'table_name': 'top_list', 'column': 'close'}],
('pct_change','d','Any'):	['融资融券交易明细 - 涨跌幅','direct',{'table_name': 'top_list', 'column': 'pct_change'}],
('turnover_rate','d','Any'):	['融资融券交易明细 - 换手率','direct',{'table_name': 'top_list', 'column': 'turnover_rate'}],
('amount','d','Any'):	['融资融券交易明细 - 总成交额','direct',{'table_name': 'top_list', 'column': 'amount'}],
('l_sell','d','Any'):	['融资融券交易明细 - 龙虎榜卖出额','direct',{'table_name': 'top_list', 'column': 'l_sell'}],
('l_buy','d','Any'):	['融资融券交易明细 - 龙虎榜买入额','direct',{'table_name': 'top_list', 'column': 'l_buy'}],
('l_amount','d','Any'):	['融资融券交易明细 - 龙虎榜成交额','direct',{'table_name': 'top_list', 'column': 'l_amount'}],
('net_amount','d','Any'):	['融资融券交易明细 - 龙虎榜净买入额','direct',{'table_name': 'top_list', 'column': 'net_amount'}],
('net_rate','d','Any'):	['融资融券交易明细 - 龙虎榜净买额占比','direct',{'table_name': 'top_list', 'column': 'net_rate'}],
('amount_rate','d','Any'):	['融资融券交易明细 - 龙虎榜成交额占比','direct',{'table_name': 'top_list', 'column': 'amount_rate'}],
('float_values','d','Any'):	['融资融券交易明细 - 当日流通市值','direct',{'table_name': 'top_list', 'column': 'float_values'}],
('reason','d','Any'):	['融资融券交易明细 - 上榜理由','direct',{'table_name': 'top_list', 'column': 'reason'}],
...
('total_share     float','d','IDX'):	['指数技术指标 - 当日总股本（股）','direct',{'table_name': 'index_indicator', 'column': 'total_share     float'}],
...
('industry','d','E'):	['股票技术指标 - 所属行业','direct',{'table_name': 'stock_indicator2', 'column': 'industry'}],
('area','d','E'):	['股票技术指标 - 所属地域','direct',{'table_name': 'stock_indicator2', 'column': 'area'}],
