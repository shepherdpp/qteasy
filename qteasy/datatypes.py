...
# ('close','d','Any'):	['融资融券交易明细 - 收盘价','event_status',{'table_name': 'top_list', 'column': 'close'}],
# ('pct_change','d','Any'):	['融资融券交易明细 - 涨跌幅','event_status',{'table_name': 'top_list', 'column': 'pct_change'}],
# ('turnover_rate','d','Any'):	['融资融券交易明细 - 换手率','event_status',{'table_name': 'top_list', 'column': 'turnover_rate'}],
# ('amount','d','Any'):	['融资融券交易明细 - 总成交额','event_status',{'table_name': 'top_list', 'column': 'amount'}],
# ('l_sell','d','Any'):	['融资融券交易明细 - 龙虎榜卖出额','event_status',{'table_name': 'top_list', 'column': 'l_sell'}],
# ('l_buy','d','Any'):	['融资融券交易明细 - 龙虎榜买入额','event_status',{'table_name': 'top_list', 'column': 'l_buy'}],
# ('l_amount','d','Any'):	['融资融券交易明细 - 龙虎榜成交额','event_status',{'table_name': 'top_list', 'column': 'l_amount'}],
# ('net_amount','d','Any'):	['融资融券交易明细 - 龙虎榜净买入额','event_status',{'table_name': 'top_list', 'column': 'net_amount'}],
# ('net_rate','d','Any'):	['融资融券交易明细 - 龙虎榜净买额占比','event_status',{'table_name': 'top_list', 'column': 'net_rate'}],
# ('amount_rate','d','Any'):	['融资融券交易明细 - 龙虎榜成交额占比','event_status',{'table_name': 'top_list', 'column': 'amount_rate'}],
# ('float_values','d','Any'):	['融资融券交易明细 - 当日流通市值','event_status',{'table_name': 'top_list', 'column': 'float_values'}],
# ('reason','d','Any'):	['融资融券交易明细 - 上榜理由','event_status',{'table_name': 'top_list', 'column': 'reason'}],
