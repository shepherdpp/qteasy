...
('sw_level1','None','IDX'):	['申万行业分类筛选 - L1','selection',{'table_name': 'sw_industry_basic', 'column': 'level', 'sel_by': 'level', 'keys': ['L1']}],
('sw_level2','None','IDX'):	['申万行业分类筛选 - L2','selection',{'table_name': 'sw_industry_basic', 'column': 'level', 'sel_by': 'level', 'keys': ['L2']}],
('sw_level3','None','IDX'):	['申万行业分类筛选 - L3','selection',{'table_name': 'sw_industry_basic', 'column': 'level', 'sel_by': 'level', 'keys': ['L3']}],
('sw_2014','None','IDX'):	['申万行业分类筛选 - 2014版本','selection',{'table_name': 'sw_industry_basic', 'column': 'src', 'sel_by': 'src', 'keys': ['SW2014']}],
('sw_2021','None','IDX'):	['申万行业分类筛选 - 2021版本','selection',{'table_name': 'sw_industry_basic', 'column': 'src', 'sel_by': 'src', 'keys': ['SW2021']}],
