...
class DataType:
    ...
    def _get_category(self, datasource, *, symbols=None) -> pd.DataFrame:
        """成份查询型的数据获取方法
...
DATA_TYPE_MAP = {
    ...
    ('s_month', 'str', 'OPT'):                        ['期权基本信息 - 结算月', 'basics',
    ...
    ('close', '1min', 'E'):                           ['股票60秒K线 - 收盘价', 'direct',
                                                       {'table_name': 'stock_1min', 'column': 'close'}],
    ('vol', '1min', 'E'):                             ['股票60秒K线 - 成交量 （手）', 'direct',
    ...
    ('close', '5min', 'E'):                           ['股票5分钟K线 - 收盘价', 'direct',
                                                       {'table_name': 'stock_5min', 'column': 'close'}],
    ('vol', '5min', 'E'):                             ['股票5分钟K线 - 成交量 （手）', 'direct',
    ...
    ('close', '15min', 'E'):                          ['股票15分钟K线 - 收盘价', 'direct',
                                                       {'table_name': 'stock_15min', 'column': 'close'}],
    ('vol', '15min', 'E'):                            ['股票15分钟K线 - 成交量 （手）', 'direct',
    ...
    ('close', '30min', 'E'):                          ['股票30分钟K线 - 收盘价', 'direct',
                                                       {'table_name': 'stock_30min', 'column': 'close'}],
    ('vol', '30min', 'E'):                            ['股票30分钟K线 - 成交量 （手）', 'direct',
    ...
    ('vol', '1min', 'IDX'):                           ['指数60秒K线 - 成交量 （手）', 'direct',
    ...
    ('vol', '5min', 'IDX'):                           ['指数5分钟K线 - 成交量 （手）', 'direct',
    ...
    ('vol', '15min', 'IDX'):                          ['指数15分钟K线 - 成交量 （手）', 'direct',
    ...
    ('vol', '30min', 'IDX'):                          ['指数30分钟K线 - 成交量 （手）', 'direct',
    ...
    ('vol', '1min', 'FT'):                            ['期货60秒K线 - 成交量 （手）', 'direct',
    ...
    ('vol', '5min', 'FT'):                            ['期货5分钟K线 - 成交量 （手）', 'direct',
    ...
    ('vol', '15min', 'FT'):                           ['期货15分钟K线 - 成交量 （手）', 'direct',
    ...
    ('vol', '30min', 'FT'):                           ['期货30分钟K线 - 成交量 （手）', 'direct',
    ...
    ('vol', '1min', 'OPT'):                           ['期权60秒K线 - 成交量 （手）', 'direct',
    ...
    ('vol', '5min', 'OPT'):                           ['期权5分钟K线 - 成交量 （手）', 'direct',
    ...
    ('vol', '15min', 'OPT'):                          ['期权15分钟K线 - 成交量 （手）', 'direct',
    ...
    ('vol', '30min', 'OPT'):                          ['期权30分钟K线 - 成交量 （手）', 'direct',
    ...
    ('close', '1min', 'FD'):                          ['基金60秒K线 - 收盘价', 'direct',
                                                       {'table_name': 'fund_1min', 'column': 'close'}],
    ('vol', '1min', 'FD'):                            ['基金60秒K线 - 成交量 （手）', 'direct',
    ...
    ('close', '5min', 'FD'):                          ['基金5分钟K线 - 收盘价', 'direct',
                                                       {'table_name': 'fund_5min', 'column': 'close'}],
    ('vol', '5min', 'FD'):                            ['基金5分钟K线 - 成交量 （手）', 'direct',
    ...
    ('close', '15min', 'FD'):                         ['基金15分钟K线 - 收盘价', 'direct',
                                                       {'table_name': 'fund_15min', 'column': 'close'}],
    ('vol', '15min', 'FD'):                           ['基金15分钟K线 - 成交量 （手）', 'direct',
    ...
    ('close', '30min', 'FD'):                         ['基金30分钟K线 - 收盘价', 'direct',
                                                       {'table_name': 'fund_30min', 'column': 'close'}],
    ('vol', '30min', 'FD'):                           ['基金30分钟K线 - 成交量 （手）', 'direct',
    ...
    ('cn_gdp_yoy', 'q', 'None'):                      ['当季同比增速（%）', 'direct',
                                                       {'table_name': 'cn_gdp', 'column': 'gdp_yoy'}],
    ('cn_gdp_pi', 'q', 'None'):                       ['第一产业累计值（亿元）', 'direct',
                                                       {'table_name': 'cn_gdp', 'column': 'pi'}],
    ('cn_gdp_pi_yoy', 'q', 'None'):                   ['第一产业同比增速（%）', 'direct',
                                                       {'table_name': 'cn_gdp', 'column': 'pi_yoy'}],
    ('cn_gdp_si', 'q', 'None'):                       ['第二产业累计值（亿元）', 'direct',
                                                       {'table_name': 'cn_gdp', 'column': 'si'}],
    ('cn_gdp_si_yoy', 'q', 'None'):                   ['第二产业同比增速（%）', 'direct',
                                                       {'table_name': 'cn_gdp', 'column': 'si_yoy'}],
    ('cn_gdp_ti', 'q', 'None'):                       ['第三产业累计值（亿元）', 'direct',
                                                       {'table_name': 'cn_gdp', 'column': 'ti'}],
    ('cn_gdp_ti_yoy', 'q', 'None'):                   ['第三产业同比增速（%）', 'direct',
                                                       {'table_name': 'cn_gdp', 'column': 'ti_yoy'}],
    ('nt_val', 'm', 'None'):                          ['全国当月值', 'direct',
                                                       {'table_name': 'cn_cpi', 'column': 'nt_val'}],
    ('nt_yoy', 'm', 'None'):                          ['全国同比（%）', 'direct',
                                                       {'table_name': 'cn_cpi', 'column': 'nt_yoy'}],
    ('nt_mom', 'm', 'None'):                          ['全国环比（%）', 'direct',
                                                       {'table_name': 'cn_cpi', 'column': 'nt_mom'}],
    ('nt_accu', 'm', 'None'):                         ['全国累计值', 'direct',
                                                       {'table_name': 'cn_cpi', 'column': 'nt_accu'}],
    ('town_val', 'm', 'None'):                        ['城市当月值', 'direct',
                                                       {'table_name': 'cn_cpi', 'column': 'town_val'}],
    ('town_yoy', 'm', 'None'):                        ['城市同比（%）', 'direct',
                                                       {'table_name': 'cn_cpi', 'column': 'town_yoy'}],
    ('town_mom', 'm', 'None'):                        ['城市环比（%）', 'direct',
                                                       {'table_name': 'cn_cpi', 'column': 'town_mom'}],
    ('town_accu', 'm', 'None'):                       ['城市累计值', 'direct',
                                                       {'table_name': 'cn_cpi', 'column': 'town_accu'}],
    ('cnt_val', 'm', 'None'):                         ['农村当月值', 'direct',
                                                       {'table_name': 'cn_cpi', 'column': 'cnt_val'}],
    ('cnt_yoy', 'm', 'None'):                         ['农村同比（%）', 'direct',
                                                       {'table_name': 'cn_cpi', 'column': 'cnt_yoy'}],
    ('cnt_mom', 'm', 'None'):                         ['农村环比（%）', 'direct',
                                                       {'table_name': 'cn_cpi', 'column': 'cnt_mom'}],
    ('cnt_accu', 'm', 'None'):                        ['农村累计值', 'direct',
                                                       {'table_name': 'cn_cpi', 'column': 'cnt_accu'}],
    ('cnt_accu', 'm', 'None'):                        ['农村累计值', 'direct',
                                                       {'table_name': 'cn_cpi', 'column': 'cnt_accu'}],
    ('ppi_yoy', 'm', 'None'):                         ['PPI：全部工业品：当月同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_yoy'}],
    ('ppi_mp_yoy', 'm', 'None'):                      ['PPI：生产资料：当月同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_mp_yoy'}],
    ('ppi_mp_qm_yoy', 'm', 'None'):                   ['PPI：生产资料：采掘业：当月同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_mp_qm_yoy'}],
    ('ppi_mp_rm_yoy', 'm', 'None'):                   ['PPI：生产资料：原料业：当月同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_mp_rm_yoy'}],
    ('ppi_mp_p_yoy', 'm', 'None'):                    ['PPI：生产资料：加工业：当月同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_mp_p_yoy'}],
    ('ppi_cg_yoy', 'm', 'None'):                      ['PPI：生活资料：当月同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_yoy'}],
    ('ppi_cg_f_yoy', 'm', 'None'):                    ['PPI：生活资料：食品类：当月同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_f_yoy'}],
    ('ppi_cg_c_yoy', 'm', 'None'):                    ['PPI：生活资料：衣着类：当月同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_c_yoy'}],
    ('ppi_cg_adu_yoy', 'm', 'None'):                  ['PPI：生活资料：一般日用品类：当月同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_adu_yoy'}],
    ('ppi_cg_dcg_yoy', 'm', 'None'):                  ['PPI：生活资料：耐用消费品类：当月同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_dcg_yoy'}],
    ('ppi_mom', 'm', 'None'):                         ['PPI：全部工业品：环比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_mom'}],
    ('ppi_mp_mom', 'm', 'None'):                      ['PPI：生产资料：环比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_mp_mom'}],
    ('ppi_mp_qm_mom', 'm', 'None'):                   ['PPI：生产资料：采掘业：环比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_mp_qm_mom'}],
    ('ppi_mp_rm_mom', 'm', 'None'):                   ['PPI：生产资料：原料业：环比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_mp_rm_mom'}],
    ('ppi_mp_p_mom', 'm', 'None'):                    ['PPI：生产资料：加工业：环比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_mp_p_mom'}],
    ('ppi_cg_mom', 'm', 'None'):                      ['PPI：生活资料：环比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_mom'}],
    ('ppi_cg_f_mom', 'm', 'None'):                    ['PPI：生活资料：食品类：环比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_f_mom'}],
    ('ppi_cg_c_mom', 'm', 'None'):                    ['PPI：生活资料：衣着类：环比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_c_mom'}],
    ('ppi_cg_adu_mom', 'm', 'None'):                  ['PPI：生活资料：一般日用品类：环比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_adu_mom'}],
    ('ppi_cg_dcg_mom', 'm', 'None'):                  ['PPI：生活资料：耐用消费品类：环比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_dcg_mom'}],
    ('ppi_accu', 'm', 'None'):                        ['PPI：全部工业品：累计同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_accu'}],
    ('ppi_mp_accu', 'm', 'None'):                     ['PPI：生产资料：累计同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_mp_accu'}],
    ('ppi_mp_qm_accu', 'm', 'None'):                  ['PPI：生产资料：采掘业：累计同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_mp_qm_accu'}],
    ('ppi_mp_rm_accu', 'm', 'None'):                  ['PPI：生产资料：原料业：累计同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_mp_rm_accu'}],
    ('ppi_mp_p_accu', 'm', 'None'):                   ['PPI：生产资料：加工业：累计同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_mp_p_accu'}],
    ('ppi_cg_accu', 'm', 'None'):                     ['PPI：生活资料：累计同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_accu'}],
    ('ppi_cg_f_accu', 'm', 'None'):                   ['PPI：生活资料：食品类：累计同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_f_accu'}],
    ('ppi_cg_c_accu', 'm', 'None'):                   ['PPI：生活资料：衣着类：累计同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_c_accu'}],
    ('ppi_cg_adu_accu', 'm', 'None'):                 ['PPI：生活资料：一般日用品类：累计同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_adu_accu'}],
    ('ppi_cg_dcg_accu', 'm', 'None'):                 ['PPI：生活资料：耐用消费品类：累计同比', 'direct',
                                                       {'table_name': 'cn_ppi', 'column': 'ppi_cg_dcg_accu'}],
    ('cn_m0', 'm', 'None'):                           ['M0（亿元）', 'direct',
                                                       {'table_name': 'cn_money', 'column': 'm0'}],
    ('cn_m0_yoy', 'm', 'None'):                       ['M0同比（%）', 'direct',
                                                       {'table_name': 'cn_money', 'column': 'm0_yoy'}],
    ('cn_m0_mom', 'm', 'None'):                       ['M0环比（%）', 'direct',
                                                       {'table_name': 'cn_money', 'column': 'm0_mom'}],
    ('cn_m1', 'm', 'None'):                           ['M1（亿元）', 'direct',
                                                       {'table_name': 'cn_money', 'column': 'm1'}],
    ('cn_m1_yoy', 'm', 'None'):                       ['M1同比（%）', 'direct',
                                                       {'table_name': 'cn_money', 'column': 'm1_yoy'}],
    ('cn_m1_mom', 'm', 'None'):                       ['M1环比（%）', 'direct',
                                                       {'table_name': 'cn_money', 'column': 'm1_mom'}],
    ('cn_m2', 'm', 'None'):                           ['M2（亿元）', 'direct',
                                                       {'table_name': 'cn_money', 'column': 'm2'}],
    ('cn_m2_yoy', 'm', 'None'):                       ['M2同比（%）', 'direct',
                                                       {'table_name': 'cn_money', 'column': 'm2_yoy'}],
    ('cn_m2_mom', 'm', 'None'):                       ['M2环比（%）', 'direct',
                                                       {'table_name': 'cn_money', 'column': 'm2_mom'}],
    ('inc_month', 'm', 'None'):                       ['社融增量当月值（亿元）', 'direct',
                                                       {'table_name': 'cn_sf', 'column': 'inc_month'}],
    ('inc_cumval', 'm', 'None'):                      ['社融增量累计值（亿元）', 'direct',
                                                       {'table_name': 'cn_sf', 'column': 'inc_cumval'}],
    ('stk_endval', 'm', 'None'):                      ['社融存量期末值（万亿元）', 'direct',
                                                       {'table_name': 'cn_sf', 'column': 'stk_endval'}],
    ('pmi010000', 'm', 'None'):                       ['制造业PMI', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010000'}],
    ('pmi010100', 'm', 'None'):                       ['制造业PMI:企业规模/大型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010100'}],
    ('pmi010200', 'm', 'None'):                       ['制造业PMI:企业规模/中型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010200'}],
    ('pmi010300', 'm', 'None'):                       ['制造业PMI:企业规模/小型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010300'}],
    ('pmi010400', 'm', 'None'):                       ['制造业PMI:构成指数/生产指数', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010400'}],
    ('pmi010401', 'm', 'None'):                       ['制造业PMI:构成指数/生产指数:企业规模/大型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010401'}],
    ('pmi010402', 'm', 'None'):                       ['制造业PMI:构成指数/生产指数:企业规模/中型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010402'}],
    ('pmi010403', 'm', 'None'):                       ['制造业PMI:构成指数/生产指数:企业规模/小型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010403'}],
    ('pmi010500', 'm', 'None'):                       ['制造业PMI:构成指数/新订单指数', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010500'}],
    ('pmi010501', 'm', 'None'):                       ['制造业PMI:构成指数/新订单指数:企业规模/大型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010501'}],
    ('pmi010502', 'm', 'None'):                       ['制造业PMI:构成指数/新订单指数:企业规模/中型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010502'}],
    ('pmi010503', 'm', 'None'):                       ['制造业PMI:构成指数/新订单指数:企业规模/小型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010503'}],
    ('pmi010600', 'm', 'None'):                       ['制造业PMI:构成指数/供应商配送时间指数', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010600'}],
    ('pmi010601', 'm', 'None'):                       ['制造业PMI:构成指数/供应商配送时间指数:企业规模/大型企业',
                                                       'direct', {'table_name': 'cn_pmi', 'column': 'pmi010601'}],
    ('pmi010602', 'm', 'None'):                       ['制造业PMI:构成指数/供应商配送时间指数:企业规模/中型企业',
                                                       'direct', {'table_name': 'cn_pmi', 'column': 'pmi010602'}],
    ('pmi010603', 'm', 'None'):                       ['制造业PMI:构成指数/供应商配送时间指数:企业规模/小型企业',
                                                       'direct', {'table_name': 'cn_pmi', 'column': 'pmi010603'}],
    ('pmi010700', 'm', 'None'):                       ['制造业PMI:构成指数/原材料库存指数', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010700'}],
    ('pmi010701', 'm', 'None'):                       ['制造业PMI:构成指数/原材料库存指数:企业规模/大型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010701'}],
    ('pmi010702', 'm', 'None'):                       ['制造业PMI:构成指数/原材料库存指数:企业规模/中型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010702'}],
    ('pmi010703', 'm', 'None'):                       ['制造业PMI:构成指数/原材料库存指数:企业规模/小型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010703'}],
    ('pmi010800', 'm', 'None'):                       ['制造业PMI:构成指数/从业人员指数', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010800'}],
    ('pmi010801', 'm', 'None'):                       ['制造业PMI:构成指数/从业人员指数:企业规模/大型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010801'}],
    ('pmi010802', 'm', 'None'):                       ['制造业PMI:构成指数/从业人员指数:企业规模/中型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010802'}],
    ('pmi010803', 'm', 'None'):                       ['制造业PMI:构成指数/从业人员指数:企业规模/小型企业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010803'}],
    ('pmi010900', 'm', 'None'):                       ['制造业PMI:其他/新出口订单', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi010900'}],
    ('pmi011000', 'm', 'None'):                       ['制造业PMI:其他/进口', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi011000'}],
    ('pmi011100', 'm', 'None'):                       ['制造业PMI:其他/采购量', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi011100'}],
    ('pmi011200', 'm', 'None'):                       ['制造业PMI:其他/主要原材料购进价格', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi011200'}],
    ('pmi011300', 'm', 'None'):                       ['制造业PMI:其他/出厂价格', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi011300'}],
    ('pmi011400', 'm', 'None'):                       ['制造业PMI:其他/产成品库存', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi011400'}],
    ('pmi011500', 'm', 'None'):                       ['制造业PMI:其他/在手订单', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi011500'}],
    ('pmi011600', 'm', 'None'):                       ['制造业PMI:其他/生产经营活动预期', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi011600'}],
    ('pmi011700', 'm', 'None'):                       ['制造业PMI:分行业/装备制造业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi011700'}],
    ('pmi011800', 'm', 'None'):                       ['制造业PMI:分行业/高技术制造业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi011800'}],
    ('pmi011900', 'm', 'None'):                       ['制造业PMI:分行业/基础原材料制造业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi011900'}],
    ('pmi012000', 'm', 'None'):                       ['制造业PMI:分行业/消费品制造业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi012000'}],
    ('pmi020100', 'm', 'None'):                       ['非制造业PMI:商务活动', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020100'}],
    ('pmi020101', 'm', 'None'):                       ['非制造业PMI:商务活动:分行业/建筑业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020101'}],
    ('pmi020102', 'm', 'None'):                       ['非制造业PMI:商务活动:分行业/服务业业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020102'}],
    ('pmi020200', 'm', 'None'):                       ['非制造业PMI:新订单指数', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020200'}],
    ('pmi020201', 'm', 'None'):                       ['非制造业PMI:新订单指数:分行业/建筑业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020201'}],
    ('pmi020202', 'm', 'None'):                       ['非制造业PMI:新订单指数:分行业/服务业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020202'}],
    ('pmi020300', 'm', 'None'):                       ['非制造业PMI:投入品价格指数', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020300'}],
    ('pmi020301', 'm', 'None'):                       ['非制造业PMI:投入品价格指数:分行业/建筑业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020301'}],
    ('pmi020302', 'm', 'None'):                       ['非制造业PMI:投入品价格指数:分行业/服务业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020302'}],
    ('pmi020400', 'm', 'None'):                       ['非制造业PMI:销售价格指数', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020400'}],
    ('pmi020401', 'm', 'None'):                       ['非制造业PMI:销售价格指数:分行业/建筑业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020401'}],
    ('pmi020402', 'm', 'None'):                       ['非制造业PMI:销售价格指数:分行业/服务业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020402'}],
    ('pmi020500', 'm', 'None'):                       ['非制造业PMI:从业人员指数', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020500'}],
    ('pmi020501', 'm', 'None'):                       ['非制造业PMI:从业人员指数:分行业/建筑业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020501'}],
    ('pmi020502', 'm', 'None'):                       ['非制造业PMI:从业人员指数:分行业/服务业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020502'}],
    ('pmi020600', 'm', 'None'):                       ['非制造业PMI:业务活动预期指数', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020600'}],
    ('pmi020601', 'm', 'None'):                       ['非制造业PMI:业务活动预期指数:分行业/建筑业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020601'}],
    ('pmi020602', 'm', 'None'):                       ['非制造业PMI:业务活动预期指数:分行业/服务业', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020602'}],
    ('pmi020700', 'm', 'None'):                       ['非制造业PMI:新出口订单', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020700'}],
    ('pmi020800', 'm', 'None'):                       ['非制造业PMI:在手订单', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020800'}],
    ('pmi020900', 'm', 'None'):                       ['非制造业PMI:存货', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi020900'}],
    ('pmi021000', 'm', 'None'):                       ['非制造业PMI:供应商配送时间', 'direct',
                                                       {'table_name': 'cn_pmi', 'column': 'pmi021000'}],
    ('pmi030000', 'm', 'None'):                       ['中国综合PMI:产出指数', 'direct',
