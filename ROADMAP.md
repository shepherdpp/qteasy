...
- **Jackie 副线（qteasy-ai）**：**Q-AI.1 ✅ 已完成**（0.1.0）；**产品顶层金标准**已立；下一可选 **Q-AI.2** 高副作用 skills
...
| [S1.5 DataType 消费契约](.cursor/plans/s1.5_datatype消费契约与三入口_a8f21c09.plan.md) | History/Reference/Static 三入口（**已完成**） |
| [S4.6 DataType 用户文档](.cursor/plans/s4.6_datatype用户文档与目录_c4e7b2d1.plan.md) | 概念章与业务目录（**已完成**） |
...
*最后更新：2026-08-22 — 2.6.4 发版；Q-AI 顶层金标准；Q-AI.1 已完成。*
