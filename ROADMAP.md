...
- **Jackie 副线（qteasy-ai）**：**Q-AI.4 TDD 已落地**（2026-08-29）；手测见 `LIVE_FIRE_DRILL_QAI4.md`；**Q-AI.5 / 阶段 E** 已立项、非当前编码（建议 1.0 闸门）
...
*最后更新：2026-08-29 — Q-AI.4 D.1–D.6 TDD 已落地；手测待 Jackie。*
