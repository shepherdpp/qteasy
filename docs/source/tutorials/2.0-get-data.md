...
**本篇在数据体验路径中的位置**：[1 安装与配置](1-get-started.md) → **2.0 下载与取数（本篇）** → [2.5 玩数据与因子分析](2.5-historypanel-data-analysis.md) →（可选 [2.6](2.6-historypanel-advanced-vertical-timeaxis.md) / [2.7](2.7-historypanel-advanced-horizontal-multifactor.md) / [2.8](2.8-historypanel-advanced-event-kline-pattern.md)）→ [3 第一个策略回测](3-start-first-strategy.md)。
