...
| --- | --- | --- | --- | --- | --- | --- | --- |
| base_date | d | E | 实施-基准日 | history | none | selected_events | dividend |
...
| block_trade_buyer | d | E | 大宗交易 - 买方营业部 | history | none | event_signal | block_trade |
| block_trade_price | d | E | 大宗交易 - 成交价 | history | history_panel,strategy | event_signal | block_trade |
| block_trade_seller | d | E | 大宗交易 - 卖方营业部 | history | none | event_signal | block_trade |
...
| change_reason | d | E | 业绩变动原因 | history | none | event_signal | forecast |
| cur_name | d | E | 股票 - 当前最新证券名称 | history | none | event_status | stock_names |
| down_limit | d | E | 跌停板 - 跌停价 | history | history_panel,strategy | direct | stock_limit |
| ex_date | d | E | 实施-除权除息日 | history | none | selected_events | dividend |
| exalter | d | E | 龙虎榜机构明细 - 营业部名称 | history | none | event_signal | top_inst |
| first_ann_date | d | E | 首次公告日 | history | none | event_signal | forecast |
...
| hk_top10_rank | d | E | 港股通十大成交 - 排名 | history | none | direct | hk_top10_stock |
...
| imp_ann_date | d | E | 实施-实施公告日 | history | none | selected_events | dividend |
| is_HS_top10 | d | E | 沪深港通十大成交股上榜 | history | none | event_signal | hs_top10_stock |
| is_suspended | d | E | 停复牌类型：S-停牌，R-复牌 | history | none | event_signal | stock_suspend |
...
| pay_date | d | E | 实施-派息日 | history | none | selected_events | dividend |
| pre_trade_day\|% | d | None | 上一交易日 | reference | reference_api,strategy | selection | trade_calendar |
| reason | d | E | 龙虎榜机构明细 - 上榜理由 | history | none | event_signal | top_inst |
| record_date | d | E | 实施-股权登记日 | history | none | selected_events | dividend |
...
| side | d | E | 龙虎榜机构明细 - 买卖类型0：买入金额最大的前5名， 1：卖出金额最大的前5名 | history | none | event_signal | top_inst |
...
| stock_holder_trade_begin_date | d | E | 股东交易 - 增减持开始日期 | history | none | event_signal | stock_holder_trade |
...
| stock_holder_trade_close_date | d | E | 股东交易 - 增减持结束日期 | history | none | event_signal | stock_holder_trade |
| stock_holder_trade_in_de | d | E | 股东交易 - 类型IN增持DE减持 | history | none | event_signal | stock_holder_trade |
| stock_holder_trade_name | d | E | 股东交易 - 股东名称 | history | none | event_signal | stock_holder_trade |
| stock_holder_trade_total_share | d | E | 股东交易 - 持股总数 | history | history_panel,strategy | event_signal | stock_holder_trade |
| stock_holder_trade_type | d | E | 股东交易 - 股东类型G高管P个人C公司 | history | none | event_signal | stock_holder_trade |
| summary | d | E | 业绩预告摘要 | history | none | event_signal | forecast |
| suspend_timing | d | E | 日内停牌时间段 | history | none | event_signal | stock_suspend |
...
| top_list_reason | d | E | 龙虎榜交易明细 - 上榜理由 | history | none | event_signal | top_list |
